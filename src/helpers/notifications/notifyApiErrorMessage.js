...
import { ERROR_MODE_CUSTOM, ERROR_MODE_EXTERNAL, ERROR_MODE_SERVER } from "../../store/constants";
import { notifyToast } from "./index";

export const notifyApiErrorMessage = (error, mode = ERROR_MODE_SERVER, duration) => {
    let message;
