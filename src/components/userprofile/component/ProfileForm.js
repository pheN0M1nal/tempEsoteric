                    ...
                    <div className="formLeftBox">
                        ...
                        <div className="inputOuter">
                            ...
                            <InputComponent
                                ...
                                onChange={(e) => {
                                    handleOnChangeInput(e, "full_name", setData, data);
                                }}
                            />
                        </div>
                        <div className="inputOuter">
                        ...
                        <div className="formfieldInner">
                            ...
                            <div className="inputOuter w-100">
                                ...
                                <InputComponent
                                    ...
                                    value={data?.bgcolor}
                                    onChange={(e) => {
                                        handleOnChangeInput(e, "bgcolor", setData, data);
                                    }}
                                />
                            </div>
                            ...
                            <div className="inputOuter w-48">
                                ...
                                <InputComponent
                                    ...
                                    value={data?.city}
                                    onChange={(e) => {
                                        handleOnChangeInput(e, "city", setData, data);
                                    }}
                                />
                            </div>
                            <div className="inputOuter w-48">
                                ...
                                <InputComponent
                                    ...
                                    onChange={(e) => {
                                        handleOnChangeInput(e, "father_name", setData, data);
                                    }}
                                />
                            </div>
                            <div className="inputOuter w-48">
                                ...
                                <InputComponent
                                    ...
                                    onChange={(e) => {
                                        handleOnChangeInput(e, "mobile_number", setData, data);
                                    }}
                                />
                            </div>
                            <div className="inputOuter textarea w-100">
                                <InputComponent
                                    ...
                                    onChange={(e) => {
                                        handleOnChangeInput(e, "website_address", setData, data);
                                    }}
                                />
                            </div>
                            <div className="inputOuter textarea w-100">
                            ...
                            <div className="inputOuter textarea w-100">
                                <InputComponent
                                    ...
                                    onChange={(e) => {
                                        handleOnChangeInput(e, "final_message", setData, data);
                                    }}
                                />
                            </div>
                        </div>
