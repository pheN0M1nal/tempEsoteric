    ...
    const handleUserSignup = async (e) => {
        ...
        axiosServerInstance()
            ...
            .then((response) => {
                ...
                window.localStorage.setItem("access_token", "faidfiaifeiiiooi232f"); // Test
        ...
        <FormComponent>
            <div className="inputOuter">
                <InputComponent
                    ...
                    height={2.5}
                    value={data.fullname}
                    onChange={(e) => HandleOnChangeInput(e, "fullname", setData, data)}
                />
            </div>
            <div className="inputOuter">
                <InputComponent
            ...
            <div className="inputOuter">
                <InputComponent
                    ...
                    height={2.5}
                    value={data.phone}
                    onChange={(e) => HandleOnChangeInput(e, "phone", setData, data)}
                />
            </div>
