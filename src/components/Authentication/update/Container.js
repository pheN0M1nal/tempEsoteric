...
const UpdationContainer = ({ showLogin }) => {
	return (
		<MainWrapper>
			<Wrapper>
				<AuthMainContainer mode={'Updation'}>
					<div className='LoginFormOuter'>
						<h2 className='title'>make a new account</h2>
						<UpdationForm showLogin={showLogin} />
					</div>
				</AuthMainContainer>
			</Wrapper>
		</MainWrapper>
...
export default UpdationContainer
