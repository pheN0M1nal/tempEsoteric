...
const Records = (props) => {
    ...
    const { isAuthenticated } = useContext(GlobalUserProfileContext);
    ...
    const handleOnPDFOpen = (item) => {
        isAuthenticated ? openModal(item.url) : fireDeleteConfirmAlert({title:"title"});
    };
                        ...
                        >
                            <div class="flip_card_inner">
                                <div class="flip_card_front">
                                    <img src={item.image} alt="image down" />
                                </div>
