        ...
        <Wrapper>
            {profile ? (
                <>
                    <ProfilePictureBoard size={2.5}>
                        <img
                            ...
                            src={
                                ...
                                profile?.profile?.picture ? profile?.profile?.picture : "noPicture"
                            }
                            alt=""
                    ...
                    {subNavToggle ? (
                        <div id="pop-nav">
                            <Link to="/userprofile" className="logout-button">
                                <img src="{profileimg}" alt="userprofile" />
                                &nbsp; Edit Profile
                            </Link>
                            <SizedBox height={0.2} />
                            <HorizontalRule />
                            <Link to={`/logout/${profile?.id}`} className="logout-button">
                                <img src="{logout}" alt="logout" />
                                &nbsp; Log Out
                            </Link>
                            <HorizontalRule />
                            <Link
                                to={profile.account_type === "Users" ? "/" : "/login"}
